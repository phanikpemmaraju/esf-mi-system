...
public class ParticipantResourceAssemblerTest {
	...
	public void testToResourcesForAParticipantSingle() throws ParseException{
		...
		List<ParticipantResource> participantResources = participantResourceAssembler.toResourcesForAParticipant(participant,participant.getParticipantId(), "/providers/1111111/participants");
		assertNotNull(participantResources);
		assertThat(participantResources.size(),is(1));
		assertThat(participantResources.get(0).getLinks().get(0).getHref(),is("/providers/1111111/participants/56dffaa6097d9818d8b455a7"));
		
		participantResources = participantResourceAssembler.toResourcesForAParticipant(participant,participant.getParticipantId(), "/providers/1111111/participants");
		assertNotNull(participantResources);
		assertThat(participantResources.size(),is(1));
		assertThat(participantResources.get(0).getLinks().get(0).getHref(),is("/providers/1111111/participants/56dffaa6097d9818d8b455a7"));
	}

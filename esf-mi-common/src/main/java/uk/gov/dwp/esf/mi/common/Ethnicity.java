...
*/
 ...
 public enum Ethnicity {
	...
	WHITE_ENGLISH(White.ENGLISH), WHITE_WELSH(White.WELSH), WHITE_SCOTTISH(White.SCOTTISH), WHITE_NORTHERN_IRISH(White.NORTHERN_IRISH), WHITE_BRITISH(White.BRITISH), WHITE_IRISH(White.IRISH),
	WHITE_GYPSY(White.GYPSY),WHITE_IRISH_TRAVELLER(White.IRISH_TRAVELLER),WHITE_OTHER(White.OTHER),
	MIXED_WHITE_BLACK_CARIBBEAN,MIXED_WHITE_BLACK_AFRICAN, WHITE_ASIAN, OTHER_ASIAN, BRITISH_INDIAN(British.INDIAN_ASIAN), BRITISH_PAKISTANI(British.PAKISTANI_ASIAN),BRITISH_BANGLADESI(British.BANGLADESHI_ASIAN),
